...
if (result.os.name) {
	if (['fedora', 'debian', 'gentoo', 'linpus', 'mageia', 'mandriva', 'meego', 'mint', 'pclinuxos', 'redhat', 'sailfish', 'slackware', 'suse', 'tizen', 'ubuntu', 'vectorlinux'].includes(result.os.name.toLowerCase())) {
		addClass('os', 'linux');
	}
